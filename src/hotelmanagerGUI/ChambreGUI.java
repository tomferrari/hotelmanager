 ...
 * @author Faysal Ahmed
 */
public class ChambreGUI extends javax.swing.JDialog {

    /**
     * Creates new form ChambreGUI
     */
    
    ChambreType roomType = new ChambreType();
    ...
    ChambreDAO roomdb = new ChambreDAO();
    public ChambreGUI(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Lits");

        jLabel1.setText("Chambre ID");
        ...
        tabbedPane.addTab("Info Chambre", jPanel1);
        ...
        tabbedPane.addTab("Type chambre", jPanel2);
        ...
        tabbedPane.getAccessibleContext().setAccessibleName("Room info");
    ...
    private void roomObjectCreation()
    {
        ...
        room.setRoom_class(new ChambreType());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChambreGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ChambreGUI dialog = new ChambreGUI(new javax.swing.JFrame(), true);
